  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      {isActive && location.pathname !== "/burst" && (
        <Link to="/burst" className="fixed left-0 right-0 z-50 md:left-64 flex items-center justify-center gap-2 bg-yellow-400 text-black text-sm font-bold py-1.5 shadow-md" style={{ top: 'calc(3rem + env(safe-area-inset-top))' }}>
