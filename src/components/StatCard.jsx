...
export default function StatCard({ icon: Icon, label, value, color, onClick, labelRight, smallLabel, labelOnTop }) {
  return (
    <div
      className={cn("bg-card border border-border rounded-xl p-5 sm:p-6 flex items-center gap-3 sm:gap-5 transition-all", onClick && "cursor-pointer hover:shadow-md hover:border-primary/30 active:scale-95")}
      onClick={onClick}
    >
