        ...
        <div className="flex-1 min-w-0">
          {editing ? (
            ...
            <div className="flex items-center gap-1 group/name">
              <h3 className={cn("font-heading font-semibold text-lg leading-snug break-words", optimisticChecked ? "line-through text-muted-foreground" : "text-foreground")}>{name}</h3>
              <button
