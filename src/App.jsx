    ...
    <AnimatePresence mode="wait">
      <Routes>
        ...
        <Route element={<Layout />}>
          ...
          { path: "/stable", el: <Stable /> }, { path: "/leaderboard", el: <Leaderboard /> }, { path: "/calendar", el: <CalendarPage /> }, { path: "/privacy", el: <Privacy /> }, { path: "/support", el: <Support /> }, { path: "/faq", el: <FAQ /> }, { path: "*", el: <PageNotFound /> }].map(({ path, el }) => (
