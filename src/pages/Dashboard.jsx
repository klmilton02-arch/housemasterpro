  ...
  return (
    <div className="space-y-7 max-w-md md:max-w-2xl mx-auto px-3 sm:px-2 pt-7" onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd}>
      ...
      <div className="grid grid-cols-2 gap-3 sm:gap-4">
          ...
          <StatCard large={largeIcons} labelRight icon={Clock} label="Pending" value={pendingTasks.length} color="bg-amber-100 text-amber-600" onClick={() => { setDrawerTaskIds(pendingTasks.map(t => t.id)); setTaskListModal({ title: 'Pending Tasks' }); }} />
      ...
      <div className="grid grid-cols-1 gap-3 sm:gap-4">
          ...
          <Link to="/calendar" className="block">
            <StatCard large={largeIcons} labelRight icon={CalendarDays} label="Calendar" value="View" color="bg-purple-100 text-purple-600" />
          </Link>
