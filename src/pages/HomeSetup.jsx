...
export default function HomeSetup() {
  ...
  function handleTouchEnd(e) {
    ...
    if (diff > 60) navigate("/profile");  // swipe left → profile
    else if (diff < -60) navigate("/family"); // swipe right → family
  ...
  return (
    <div className="space-y-3 max-w-xs mx-auto px-1 pt-6" onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd} style={{ touchAction: 'pan-y' }}>
      <div>
