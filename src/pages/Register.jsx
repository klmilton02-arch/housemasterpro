    ...
    >
      <div className="space-y-3 mb-6">
        ...
        <Button variant="outline" className="w-full h-12 text-sm font-medium" onClick={handleMicrosoft}>
          <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24" fill="none"><rect x="1" y="1" width="10" height="10" fill="#F25022"/><rect x="13" y="1" width="10" height="10" fill="#7FBA00"/><rect x="1" y="13" width="10" height="10" fill="#00A4EF"/><rect x="13" y="13" width="10" height="10" fill="#FFB900"/></svg>
